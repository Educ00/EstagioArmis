ALTER TABLE Pedido DROP CONSTRAINT FKPedido850587;
ALTER TABLE Entity DROP CONSTRAINT FKEntity722832;
ALTER TABLE Pedido_Produto DROP CONSTRAINT FKPedido_Pro775026;
ALTER TABLE Pedido_Produto DROP CONSTRAINT FKPedido_Pro84987;
ALTER TABLE Pedido DROP CONSTRAINT FKPedido975345;
ALTER TABLE Staff DROP CONSTRAINT FKStaff192925;
