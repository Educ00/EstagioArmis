...
from core.constants import prompt_template, prompt_instructions1, prompt_instructions2, prompt_instructions3, \
    ...
    prompt_template3, instructions_format_answer_to_question
...
class AzureService:    
    ...
    def make_question(self, question):
        ...
        self.azure_adapter.create_new_with_output_schema(json_schema=json_schema2)
    ...
    def extract_entities_and_relations(self, file_name: str, save_to_file: bool = True):
        self.azure_adapter.create_new_with_output_schema(json_schema=json_schema1)
